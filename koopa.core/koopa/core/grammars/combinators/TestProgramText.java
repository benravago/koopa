...
/**
 * This {@linkplain ParserCombinator} provides the basis for testing
 * the {@linkplain AreaTag#PROGRAM_TEXT_AREA} matched by a given parser.
 */
public abstract class TestProgramText extends GrammaticalCombinator {
    ...
    protected boolean matchesAfterSkipped(Parse parse) {
        ...
        var text = Streams.getProgramTextFromBookmark(grammar, stream);
     ...
     * but passes along the contents of all matched tokens
     * which are accepted by {@linkplain Grammar#isProgramText(Data)}.
     * <p>
     * This will not get called if the {@link #parser} did not match.
     */
    protected abstract boolean matchesProgramText(Parse parse, String programText);
