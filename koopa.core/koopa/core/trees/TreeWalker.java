...
public class TreeWalker {
    ...
    /**
     * This stores the state at a certain point in the traversal.
     * You can use these to restore the state to any point.
     */
    ...
    private boolean right() {
        ...
        var siblingIndex = current.getChildIndex() + 1;
     ...
     * <p>
     * <b>Note.</b> This assumes that the current position is somewhere in the given subtree,
     * but there is no explicit check that this is indeed true...
     */
    ...
    /**
     * Set the state of this TreeWalker to a previous configuration (retrieved via {@linkplain #getState()}).
     */
