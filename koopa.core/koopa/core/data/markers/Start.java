...
/**
 * Marks the start of a structure/branch.
 *
 * Think of this like an opening tag in XML.
 * <p>
 * This uses a singleton-like approach in that
 * there can be no two instances of this which share the same name and namespace.
 */
