...
/**
 * This {@linkplain ParserCombinator} tests whether the text matched by a given parser is in a given case or not.
 * Clients can configure which case (upper or lower, all of it or some) should have this parser accept the input.
 */
public class TestForCase extends TestProgramText {
    ...
    public TestForCase(Grammar grammar, boolean isUppercase, boolean trueForAll, ParserCombinator parser) {
