...
public class KGGrammar extends FluentGrammar {
  ...
  public KGGrammar() {
    ...
    // [modifier] 'def' [nokeywords] identifier '=' sequence (nested_rule)* 'end'
    ...
    // 'where' [modifier] 'def' [nokeywords] identifier '=' sequence (nested_rule)* 'end'
    ...
    // ( '`' ++ (%someLowercase word) | %noKeyword (%someLowercase word) )
