...
/**
 * Because the standard Java library doesn't have this.
 *
 * This is the (minimal) Set equivalent of {@linkplain WeakHashMap}.
 * Heck, it is just a {@linkplain WeakHashMap} with a reduced interface.
 */
