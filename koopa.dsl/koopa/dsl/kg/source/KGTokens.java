...
public final class KGTokens {
    private KGTokens() {}

    public static Source getNewSource(String resourceName, Reader reader) {

        // Split lines...
        final LineSplitter lineSplitter = new LineSplitter(resourceName, reader);

        // And mark everything as program text...
        final TagAll tagAllAsProgramText = new TagAll(lineSplitter, PROGRAM_TEXT_AREA);

        // Separate the tokens...
        final TokenSeparator tokenSeparator = new TokenSeparator(tagAllAsProgramText);
