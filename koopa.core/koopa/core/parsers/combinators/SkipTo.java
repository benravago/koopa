...
/**
 * This {@linkplain ParserCombinator} consumes tokens until it has reached a certain point in the stream,
 * as identified by a given {@linkplain ParserCombinator}.
 * 
 * The match for the limiting parser will be rollbacked,
 * so that from a point of view of the grammar you'll be a the point where the limiting parser will match.
 * <p>
 * The tokens which were skipped will be wrapped with {@linkplain InWater} and {@linkplain OnLand} markers.
 */
