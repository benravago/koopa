...
/**
 * This {@linkplain ParserCombinator} tests whether the text matched by a given parser is a keyword or not.
 * Clients can configure which case (keyword or not) should have this parser accept the input.
 */
public class TestForKeyword extends TestProgramText {

    private final boolean acceptKeyword;

    public TestForKeyword(Grammar grammar, boolean acceptKeyword, ParserCombinator parser) {
