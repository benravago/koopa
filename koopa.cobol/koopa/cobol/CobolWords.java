...
public final class CobolWords {
    ...
    static {
        var maxCobolWordLengthSetting = System.getProperty("koopa.maxCobolWordLength", "" + DEFAULT_MAX_LENGTH);
    ...
    static {
        if ("extended".equalsIgnoreCase(System.getProperty("koopa.cobolWord.inCopybooks"))) {
    ...
    static {
        var characters = System.getProperty("koopa.cobolWord.extendedCharacters");
        if (characters != null) {
