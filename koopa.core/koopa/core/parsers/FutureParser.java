 ...
 * 
 * This is needed by grammars which have parser definitions which refer to each other (either directly or indirectly).
 * To prevent infinite recursion in such a case you can first create instances of this class, and then install the definitions later.
 */
